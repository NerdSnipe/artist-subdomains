    ...
    return (
        <div className="overflow-hidden border-y-4 border-black bg-black">
            <div
                ...
                style={{
                    animation: ready ? `anthem-marquee ${speedSeconds}s linear infinite` : "none",
            ...
            >
                {doubled.map((item, i) => (
                    <span
                        key={i}
                        className="mx-6 shrink-0 font-[family-name:var(--font-display)] uppercase tracking-wide text-[15px] text-[#FFDC00] flex items-center gap-6"
                    >
                        {item}
