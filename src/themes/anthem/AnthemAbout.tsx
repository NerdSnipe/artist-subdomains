    ...
    return (
        <div>
            <section className="border-b-4 border-black bg-[#F7F4EC]">
                <div className="max-w-[1500px] mx-auto px-5 md:px-10 py-16 md:py-24 grid grid-cols-1 md:grid-cols-[1.1fr_0.9fr] gap-12 items-center">
                    <Reveal>
                        ...
                        {artist.bio && (
                            <p className="text-lg leading-relaxed text-black/80 whitespace-pre-line first-letter:font-[family-name:var(--font-display)] first-letter:text-6xl first-letter:leading-[0.8] first-letter:float-left first-letter:pr-3 first-letter:pt-1">
                                {artist.bio}
                            </p>
                        )}
                    </Reveal>
            ...
            {artist.artistStatement && (
                <section className="bg-black text-[#F7F4EC] border-b-4 border-black py-20 md:py-28">
                    <Reveal className="max-w-[1000px] mx-auto px-5 md:px-10 text-center">
